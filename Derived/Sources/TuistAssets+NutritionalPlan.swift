...
public enum NutritionalPlanAsset {
  ...
  public static let accentColor = NutritionalPlanColors(name: "AccentColor")
    public static let logo = NutritionalPlanImages(name: "logo")
  }
...
public final class NutritionalPlanColors {
...
public extension NutritionalPlanColors.Color {
  @available(iOS 11.0, tvOS 11.0, watchOS 4.0, macOS 10.13, visionOS 1.0, *)
  convenience init?(asset: NutritionalPlanColors) {
