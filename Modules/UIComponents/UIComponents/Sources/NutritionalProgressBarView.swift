...
public struct NutritionalProgressBarView: View {
    ...
    public init(carbohydrateProgress: Binding<Double>,
                proteinProgress: Binding<Double>,
                fatProgress: Binding<Double>) {
        self._carbohydrateProgress = carbohydrateProgress
        self._proteinProgress = proteinProgress
        self._fatProgress = fatProgress
    }
