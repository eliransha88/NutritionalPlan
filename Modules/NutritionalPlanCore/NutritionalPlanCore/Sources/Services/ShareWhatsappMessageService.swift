...
public protocol ShareWhatsappMessageServiceProtocol {
    func shareWhatsapp(message: String, phoneNumber: String)
}

public class ShareWhatsappMessageService: ShareWhatsappMessageServiceProtocol {
    
    public init() {}
            
    public func shareWhatsapp(message: String, phoneNumber: String) {
